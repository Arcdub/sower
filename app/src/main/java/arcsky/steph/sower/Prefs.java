...
public final class Prefs {
    ...
    /** How to distinguish the words of Jesus: red, bold (colour-blind friendly), or none. */
    public static int wordsOfJesusStyle(Context context) {
        return prefs(context).getInt(KEY_WJ_STYLE, RedLetter.STYLE_RED);
    }
